...
def scrapy_info_mid(keyword, mid_list):
    ...
    # add start_time to figure out total cost time
    ...
    for idx in search_result.index:
        get_reposts_info(rootdir, search_result.ix[idx, 'uid'], search_result.ix[idx:idx, 'mid'],
                         search_result.ix[idx:idx, 'reposts_count'])
        get_comments_info(rootdir, search_result.ix[idx, 'uid'], search_result.ix[idx:idx, 'mid'],
                          search_result.ix[idx:idx, 'comments_count'])
